...
# Copied from:
# https://github.com/johnnywalleye/ufldl_templates/blob/master/display_network.py
# It appears to be a a line by line conversion of the matlab code.. which might be
# inefficient .. .the number of for loops might be reducible.
...
def display_network(A, filename='weights.png'):
    ...
    h = plt.imshow(image, cmap=matplotlib.cm.gray)
    return [h, image]
